...
A minimal single-player Ludo web scaffold built with React, TypeScript, and Vite. It now includes a basic, locally run rules engine (turn order, legal move generation, capturing, and safe tiles) plus a Home page for configuring human/AI players and a Game page with a canvas-rendered circular board you can click to move highlighted pieces.
